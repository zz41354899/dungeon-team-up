      ...
      <div v-if="showSearchModal" class="fixed inset-0 z-[9999] flex items-center justify-center">
        ...
        <div class="relative max-w-2xl w-full mx-4 bg-gray-900/90 border border-white/10 rounded-2xl shadow-md p-6">
          <div class="flex justify-between items-center mb-6">
            <h3 class="text-2xl font-bold text-white">所有任務</h3>
            <button 
              ...
              >
                <div class="flex items-start justify-between">
                  <div>
                    ...
                    <p class="text-sm text-gray-400 mb-3">{{ mission.description || '無說明' }}</p>
                    <div class="flex items-center space-x-3 flex-wrap gap-2">
                      <span class="px-3 py-1 bg-emerald-500/20 rounded-lg text-xs text-emerald-300">
                        專案：{{ mission.projects?.title || '未知專案' }}
                      </span>
                      <span class="px-3 py-1 bg-blue-500/20 rounded-lg text-xs text-blue-300">
